...
constexpr Value PieceValue[PHASE_NB][PIECE_NB] = {
    {VALUE_ZERO, PawnValueMg, KnightValueMg, BishopValueMg, RookValueMg,
     QueenValueMg, VALUE_ZERO, VALUE_ZERO, VALUE_ZERO, PawnValueMg,
     KnightValueMg, BishopValueMg, RookValueMg, QueenValueMg, VALUE_ZERO,
     VALUE_ZERO},
    {VALUE_ZERO, PawnValueEg, KnightValueEg, BishopValueEg, RookValueEg,
     QueenValueEg, VALUE_ZERO, VALUE_ZERO, VALUE_ZERO, PawnValueEg,
     KnightValueEg, BishopValueEg, RookValueEg, QueenValueEg, VALUE_ZERO,
     VALUE_ZERO}};
...
/// (enum). The least significant 16 bits are used to store the middlegame value
/// and the upper 16 bits are used to store the endgame value. We have to take
...
/// Multiplication of a Score by an integer. We check for overflow in debug
/// mode.
inline Score operator*(Score s, int i) {
